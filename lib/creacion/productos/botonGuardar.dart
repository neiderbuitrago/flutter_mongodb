...
import 'package:flutter_mongodb/modelos/identificador.dart';
      ...
      onPressed: () {
        if (estadoProducto.formKey.value.currentState!.validate()) {
          ...
          if (estadoProducto.manejaVentaFraccionada.value) {
            ...
            FraccionesDB.insertar(fracciones).then((value) =>
                limpiarControlador(
                    estadoIdentificador.controllerIdentificador));
          }
